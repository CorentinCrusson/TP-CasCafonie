...
class mypdo extends PDO{
    ...
    private $PARAM_utilisateur='id11873014_admincafonie';//'id11873014_admincafonie'; // nom d'utilisateur pour se connecter
    private $PARAM_mot_passe='-ktnP*Y0-?E@1J[/';//'-ktnP*Y0-?E@1J[/'; // mot de passe de l'utilisateur pour se connecter
    private $PARAM_nom_bd='id11873014_cascafonie';
    private $connexion;
